Define two packages–General and Marketing. In General package define a class,Employee with data members as empid(protected), ename(private) and a public method as 
